...
public class BoFlora121RiskUtils {

    public static boolean isFlora121Emulator() {
    ...
    public static boolean isFlora121Emulator2() {
        if (exFlora121istFile(new String[]{"/dev/socket/genyd", "/dev/socket/baseband_genyd"}) ||
                exFlora121istFile(new String[]{"fstab.andy", "ueventd.andy.rc"}) ||
                exFlora121istFile(new String[]{"fstab.nox", "init.nox.rc", "ueventd.nox.rc"}) ||
                exFlora121istFile(new String[]{"/dev/socket/qemud", "/dev/qemu_pipe"}) ||
                exFlora121istFile(new String[]{"ueventd.android_x86.rc", "x86.prop", "ueventd.ttVM_x86.rc",
    ...
    public static boolean isFlora121DevModel(Context context) {
        try {
    ...
    public static boolean isFlora121Debug(Context context) {
        try {
    ...
    public static boolean isFlora121Xposed() {
        try {
    ...
    public static boolean isFlora121AbnormalEnv() {
        if ("0".equals(getFlora121Property("ro.secure", "1"))) {
            return true;
        }
    ...
    public static boolean isFlora121Vpn() {
        try {
    ...
    public static boolean isFlora121Sim(Context context) {
        try {
    ...
    public static String getFlora121Installer(Context context) {
        String installer = "";
        try {
    ...
    private static boolean exFlora121istFile(String[] files) {
    ...
    private static String getFlora121Property(String key, String defaultValue) {
        try {
