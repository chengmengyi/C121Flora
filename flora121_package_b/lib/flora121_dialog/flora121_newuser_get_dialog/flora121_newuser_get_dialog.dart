...
import 'package:flora121_package_b/flora121_dialog/flora121_newuser_get_dialog/flora121_newuser_get_dialog_con.dart';
...
class Flora121NewuserGetDialog extends Flora121BaseDialog<Flora121NewuserGetDialogCon>{
  double addNum;
  Function(bool received) dismissCallback;
  Flora121NewuserGetDialog({
    required this.addNum,
    required this.dismissCallback,
});

  @override
  Flora121NewuserGetDialogCon initBaseConFlora121() => Flora121NewuserGetDialogCon();
  ...
  _progressListWidget()=>GetBuilder<Flora121NewuserGetDialogCon>(
    id: "progress",
    builder: (_)=>Column(
      mainAxisSize: MainAxisSize.min,
