...
class Flora121NoWheelDialogCon extends Flora121BaseCon{
  ...
  void onInit() {
    super.onInit();
    Flora121Ttt.instance.uploadPointEvent(pointEnum: Flora121PointEnum.wheel_num);
  }
  ...
  clickAd(){
    Flora121Ttt.instance.uploadPointEvent(pointEnum: Flora121PointEnum.wheel_num_ad_c);
