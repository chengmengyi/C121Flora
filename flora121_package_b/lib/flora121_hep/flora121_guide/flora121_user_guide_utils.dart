...
import 'package:flora121_package_b/flora121_hep/flora121_guide/flora121_new_user_guide_step.dart';
...
class Flora121UserGuideUtils{
  ...
  String _step=Flora121NewUserGuideStep.step1GuideMoney;

  checkShowNewUserGuide(){
    if(!bShowNewUserGuide.getData()){
      return;
    }
    // if(_step!=Flora121NewUserGuideStep.step1GuideMoney){
    //   return;
    // }
  ...
  _showStep2Guide(BuildContext context){
    _step=Flora121NewUserGuideStep.step2GuideHomeTopMoney;
    showOverlay(
      context: context,
      widget: Flora121NewUserStep2View(
        ...
        dismissCallback: (){
          hideOverlay();
          _step=Flora121NewUserGuideStep.step3GuideDice;
  ...
  showStep4Overlay(BuildContext context,Offset offset){
    showOverlay(
      context: context,
