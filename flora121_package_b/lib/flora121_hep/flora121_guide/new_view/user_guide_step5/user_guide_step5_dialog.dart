            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Flora121TextView(text: "Your first cash is one tap away.", color: "#D27A16", size: 16.sp,fontWeight: FontWeight.bold,),
                  Flora121TextView(text: "Withdrawal information registration", color: "#3F591B", size: 14.sp,fontWeight: FontWeight.bold,),
                  Flora121TextView(text: "Ensure the safety of your funds", color: "#3F591B", size: 14.sp,fontWeight: FontWeight.bold,),
                ],
              ),
            ),
